...
tirol.4$V2[tirol.4$V6 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V2'] <- 'e.fach'

# e.allgemein
tirol.4$V7[tirol.4$V8 == "x"] <- "1"
tirol.4$V7[tirol.4$V9 == "x"] <- "2"
tirol.4$V7[tirol.4$V10 == "x"] <- "3"
tirol.4$V7[tirol.4$V11 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V7'] <- 'e.allgemein'

# e.schueler
tirol.4$V12[tirol.4$V13 == "x"] <- "1"
tirol.4$V12[tirol.4$V14 == "x"] <- "2"
tirol.4$V12[tirol.4$V15 == "x"] <- "3"
tirol.4$V12[tirol.4$V16 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V12'] <- 'e.schueler'

# e.planung
tirol.4$V17[tirol.4$V18 == "x"] <- "1"
tirol.4$V17[tirol.4$V19 == "x"] <- "2"
tirol.4$V17[tirol.4$V20 == "x"] <- "3"
tirol.4$V17[tirol.4$V21 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V17'] <- 'e.planung'

# e.handy
tirol.4$V22[tirol.4$V23 == "x"] <- "1"
tirol.4$V22[tirol.4$V24 == "x"] <- "2"
tirol.4$V22[tirol.4$V25 == "x"] <- "3"
tirol.4$V22[tirol.4$V26 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V22'] <- 'e.handy'

# fortbildung
tirol.4$V27[tirol.4$V28 == "x"] <- "1"
tirol.4$V27[tirol.4$V29 == "x"] <- "2"
tirol.4$V27[tirol.4$V30 == "x"] <- "3"
tirol.4$V27[tirol.4$V31 == "x"] <- "k.A."
names(tirol.4)[names(tirol.4) == 'V27'] <- 'fortbildung'

# sonstiges
names(tirol.4)[names(tirol.4) == 'V32'] <- 'sonstiges'
